"""Structural contract test for the `weekly-learning-synthesis` skill.
...
def test_weekly_learning_synthesis_structure():
    assert_skill_structure("weekly-learning-synthesis")
